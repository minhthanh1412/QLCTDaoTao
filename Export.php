...
if(isset($_POST['btnExport']))
{
	...
	{ 
		...
		$sql = "SELECT id, tenMon, tongSoTC, soTCLyThuyet, soTCThuchanh, batbuoc FROM tblmonhoc, tblchitietctdt WHERE tblmonhoc.id = tblchitietctdt.maMH AND tblchitietctdt.soTTHK = $i AND tblchitietctdt.maCT = $maCT ORDER BY batbuoc DESC";
