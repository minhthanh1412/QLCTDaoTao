    ...
    <div class ="selCTDT" style="text-align: center;">
        <form  name="frmCapNhat" id="frmCapNhat" method="POST">
            <div class="form-group">
                ...
                <a href="Export.php"><img src="images/excel.png" data-toggel="tooltip" title="Xuất chương trình Đào tạo Excel.." style="width: 3%; margin-left: 0px" /></a>
...
$('#ShowTC').on('click', function(){
 ...
 for(var i=0; i<table2.data().length; i++)
 {
    if(table2.data()[i]["active"]==1){
        tongLT+=parseFloat(table2.data()[i]["soTCLyThuyet"]);
        tongTH+=parseFloat(table2.data()[i]["soTCThuchanh"]);
    }
 }
 
 for(var i=0; i<tblhki2.data().length; i++)
 {
    if(tblhki2.data()[i]["active"]==1){
        tongLT+=parseFloat(tblhki2.data()[i]["soTCLyThuyet"]);
        tongTH+=parseFloat(tblhki2.data()[i]["soTCThuchanh"]);
    }
 }
 for(var i=0; i<tblhki3.data().length; i++)
 {
    if(tblhki3.data()[i]["active"]==1){
        tongLT+=parseFloat(tblhki3.data()[i]["soTCLyThuyet"]);
        tongTH+=parseFloat(tblhki3.data()[i]["soTCThuchanh"]);
    }
 }
 for(var i=0; i<tblhki4.data().length; i++)
 {
    if(tblhki4.data()[i]["active"]==1){
        tongLT+=parseFloat(tblhki4.data()[i]["soTCLyThuyet"]);
        tongTH+=parseFloat(tblhki4.data()[i]["soTCThuchanh"]);
    }
 }
 for(var i=0; i<tblhki5.data().length; i++)
 {
    if(tblhki5.data()[i]["active"]==1){
        tongLT+=parseFloat(tblhki5.data()[i]["soTCLyThuyet"]);
        tongTH+=parseFloat(tblhki5.data()[i]["soTCThuchanh"]);
    }
 }
 for(var i=0; i<tblhki6.data().length; i++)
 {
    if(tblhki6.data()[i]["active"]==1){
        tongLT+=parseFloat(tblhki6.data()[i]["soTCLyThuyet"]);
        tongTH+=parseFloat(tblhki6.data()[i]["soTCThuchanh"]);
    }
 }
 for(var i=0; i<tblhki7.data().length; i++)
 {
    if(tblhki7.data()[i]["active"]==1){
        tongLT+=parseFloat(tblhki7.data()[i]["soTCLyThuyet"]);
        tongTH+=parseFloat(tblhki7.data()[i]["soTCThuchanh"]);
    }
 }
 for(var i=0; i<tblhki8.data().length; i++)
 {
    if(tblhki8.data()[i]["active"]==1){
        tongLT+=parseFloat(tblhki8.data()[i]["soTCLyThuyet"]);
        tongTH+=parseFloat(tblhki8.data()[i]["soTCThuchanh"]);
    }
 }
  $("#txtTongTCLT").val(tongLT);
   $("#txtTongTCTH").val(tongTH);
    $("#txtTongTC").val(tongLT+tongTH);
});
